...
class TestCreateProcess:
    def test_create_process(self, driver_function):
        ...
        create_process = CreateProcess(driver_function, process_code="Custom_",
    ...
    def test_process_name_already_exist(self, driver_function):
        ...
        open_filter = FilterSearch(driver_function)
        open_process = OpenProcess(driver_function)
        create_process = CreateProcess(driver_function,  process_code="SMK_PLAY_24OCT_A",
    ...
    def test_create_process_with_multiple_channels(self, driver_function):
        ...
        open_filter = FilterSearch(driver_function)
        open_process = OpenProcess(driver_function)
        create_process_page = CreateProcess(driver_function,process_code="MULTI_CHANNEL_CODE_1",
    ...
    def test_create_process_with_review_rating_false(self, driver_function):
        ...
        open_filter = FilterSearch(driver_function)
        open_process = OpenProcess(driver_function)
        create_process_page = CreateProcess(driver_function, process_code="NO_REVIEW_CODE",
    ...
    def test_process_code_max_length_validation(self, driver_function):
        ...
        open_filter = FilterSearch(driver_function)
        open_process = OpenProcess(driver_function)
        create_process_page = CreateProcess(driver_function,process_code=long_code,
    ...
    def test_empty_process_code(self, driver_function):
        ...
        open_filter = FilterSearch(driver_function)
        open_process = OpenProcess(driver_function)
        create_process_page = CreateProcess(driver_function, process_code="",
    ...
    def test_empty_process_name(self, driver_function):
        ...
        open_filter = FilterSearch(driver_function)
        open_process = OpenProcess(driver_function)
        create_process_page = CreateProcess(driver_function,process_code="EMPTY_NAME_CODE",
            process_name="",
            review_rating=False,
            channels=["chat"])
    ...
    def test_no_channel_selected(self, driver_function):
        ...
        open_filter = FilterSearch(driver_function)
        open_process = OpenProcess(driver_function)
        create_process_page = CreateProcess(driver_function,process_code="NO_CHANNEL_CODE",
    ...
    def test_special_characters_in_process_code(self, driver_function):
        ...
        open_filter = FilterSearch(driver_function)
        open_process = OpenProcess(driver_function)
        create_process_page = CreateProcess(driver_function,process_code="ABC!@#",
            process_name="",
            review_rating=False,
            channels=["chat"])
