...
from pages.process.process_manager.edit_process import EditProcess
...
class TestVideoSAConfig:
    ...
    def test_chat_config_sa(self, driver_function):
        ...
        stt_cfg = full_cfg["channel_config"]["video"]["sa"]
        ...
        try:
            ...
            edit_process = EditProcess(driver)


            sa_config = VideoSAConfig(
            ...
            loader.load()
            assert create_process.ensure_channel_enabled("video"), "Video channel could not be enabled"
