...
class TestChatVersion:

    def test_chat_import_version(self, driver_function):
        ...
        version = VersionChatConfig(driver_function)
        ...
        version.open_chat_version_section()
    ...
    def test_chat_copy_version(self, driver_function):
        login = LoginPage(driver_function)
        loader = Loader(driver_function)
        logout = Logout(driver_function)
        side_menu = SideMenuPage(driver_function)
    ...
    def test_chat_add_version_json(self, driver_function):
        login = LoginPage(driver_function)
        loader = Loader(driver_function)
        logout = Logout(driver_function)
        side_menu = SideMenuPage(driver_function)
    ...
    def test_chat_add_version(self, driver_function):
        login = LoginPage(driver_function)
        loader = Loader(driver_function)
        logout = Logout(driver_function)
        side_menu = SideMenuPage(driver_function)
