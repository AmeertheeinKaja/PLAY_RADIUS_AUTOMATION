...
from pages.process.version.version_video_config import VersionVideoConfig
...
class TestVideoVersion:
    ...
    def test_video_import_version(self, driver_function):
        ...
        version = VersionVideoConfig(driver_function)
        ...
        version.open_video_version_section()
    ...
    def test_video_copy_version(self, driver_function):
        login = LoginPage(driver_function)
        loader = Loader(driver_function)
        logout = Logout(driver_function)
        side_menu = SideMenuPage(driver_function)
    ...
    def test_video_add_version_json(self, driver_function):
        login = LoginPage(driver_function)
        loader = Loader(driver_function)
        logout = Logout(driver_function)
        side_menu = SideMenuPage(driver_function)
    ...
    def test_video_add_version(self, driver_function):
        login = LoginPage(driver_function)
        loader = Loader(driver_function)
        logout = Logout(driver_function)
        side_menu = SideMenuPage(driver_function)
