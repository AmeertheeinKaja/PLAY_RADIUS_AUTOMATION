...
class VersionCallConfig(BasePage):
    ...
    def call_version_accord(self):
        try:
            call_version_accord=self.wait_until_clickable(self.CALL_VERSION_ACCORD)
            call_version_accord.click()
            self.wait_until_clickable(self.CALL_VERSION_ACCORD)
