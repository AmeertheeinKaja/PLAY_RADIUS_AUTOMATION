...
class VideoSAConfig(BasePage):
    ...
    SA_RESET_BTN = (By.XPATH, f"{VIDEO_CONFIG_SCOPE}//button[@title='Reset']")
    ...
    SA_RADIO_CONVERSION_MODE = (By.XPATH, f"{VIDEO_CONFIG_SCOPE}//*[@id='manualModeSa_video']")
        ...
        try:
            ...
            try:
                toggle_sa = self.driver.find_element(By.XPATH,
                                                     "//*[@id='sa-tab-video-pane']/div/form/div/div/div[2]/div/div[1]/div/label[2]/span")
