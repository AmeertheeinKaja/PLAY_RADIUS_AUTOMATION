...
class ChatStorageConfig(BasePage):

    CHAT_CONFIG_SCOPE = "//div[@id='media-configuration-chat']"

    # Tabs
    TAB_STORAGE_TYPE = (By.XPATH, f"{CHAT_CONFIG_SCOPE}//button[@id='home-tab-chat']")

    # Radio buttons
    STORAGE_RADIO_HTTP = (By.XPATH, f"{CHAT_CONFIG_SCOPE}//input[@name='type' and @value='http/https']")
    STORAGE_RADIO_SFTP = (By.XPATH, f"{CHAT_CONFIG_SCOPE}//input[@name='type' and @value='sftp']")
    STORAGE_RADIO_FTP  = (By.XPATH, f"{CHAT_CONFIG_SCOPE}//input[@name='type' and @value='ftp']")
    ...
    STORAGE_SFTP_PORT = (By.XPATH, f"{CHAT_CONFIG_SCOPE}//input[@name='port']")
    STORAGE_SFTP_USERNAME = (By.XPATH, f"{CHAT_CONFIG_SCOPE}//input[@name='user']")
    STORAGE_SFTP_PASSWORD = (By.XPATH, f"{CHAT_CONFIG_SCOPE}//input[@name='password']")
    STORAGE_SFTP_DIR_PATH = (By.XPATH, f"{CHAT_CONFIG_SCOPE}//input[@name='dirPath']")

    # FTP fields
    STORAGE_FTP_HOSTNAME = (By.XPATH, f"{CHAT_CONFIG_SCOPE}//input[@name='host']")
    STORAGE_FTP_PORT = (By.XPATH, f"{CHAT_CONFIG_SCOPE}//input[@name='port']")
    STORAGE_FTP_USERNAME = (By.XPATH, f"{CHAT_CONFIG_SCOPE}//input[@name='user']")
    STORAGE_FTP_PASSWORD = (By.XPATH, f"{CHAT_CONFIG_SCOPE}//input[@name='password']")
    STORAGE_FTP_DIR_PATH = (By.XPATH, f"{CHAT_CONFIG_SCOPE}//input[@name='dirPath']")

    # Common buttons (global)
    STORAGE_RESET_BTN = (By.XPATH, f"{CHAT_CONFIG_SCOPE}//button[@title='Reset']")
    STORAGE_SAVE_BTN  = (By.XPATH, f"{CHAT_CONFIG_SCOPE}//button[@title='Save']")
