...
class EmailStorageConfig(BasePage):

    EMAIL_CONFIG_SCOPE = "//div[@id='media-configuration-email']"

    # Tabs
    TAB_STORAGE_TYPE = (By.XPATH, f"{EMAIL_CONFIG_SCOPE}//button[@id='home-tab-email']")

    # Radio buttons
    STORAGE_RADIO_HTTP = (By.XPATH, f"{EMAIL_CONFIG_SCOPE}//input[@name='type' and @value='http/https']")
    STORAGE_RADIO_SFTP = (By.XPATH, f"{EMAIL_CONFIG_SCOPE}//input[@name='type' and @value='sftp']")
    STORAGE_RADIO_FTP  = (By.XPATH, f"{EMAIL_CONFIG_SCOPE}//input[@name='type' and @value='ftp']")

    # HTTP fields
    STORAGE_HTTP_URL = (By.XPATH, f"{EMAIL_CONFIG_SCOPE}//input[@name='dirPath']")
    STORAGE_HTTP_SUCCESS="Channel updated successfully"

    # SFTP fields
    STORAGE_SFTP_HOSTNAME = (By.XPATH, f"{EMAIL_CONFIG_SCOPE}//input[@name='host']")
    STORAGE_SFTP_PORT = (By.XPATH, f"{EMAIL_CONFIG_SCOPE}//input[@name='port']")
    STORAGE_SFTP_USERNAME = (By.XPATH, f"{EMAIL_CONFIG_SCOPE}//input[@name='user']")
    STORAGE_SFTP_PASSWORD = (By.XPATH, f"{EMAIL_CONFIG_SCOPE}//input[@name='password']")
    STORAGE_SFTP_DIR_PATH = (By.XPATH, f"{EMAIL_CONFIG_SCOPE}//input[@name='dirPath']")

    # FTP fields
    STORAGE_FTP_HOSTNAME = (By.XPATH, f"{EMAIL_CONFIG_SCOPE}//input[@name='host']")
    STORAGE_FTP_PORT = (By.XPATH, f"{EMAIL_CONFIG_SCOPE}//input[@name='port']")
    STORAGE_FTP_USERNAME = (By.XPATH, f"{EMAIL_CONFIG_SCOPE}//input[@name='user']")
    STORAGE_FTP_PASSWORD = (By.XPATH, f"{EMAIL_CONFIG_SCOPE}//input[@name='password']")
    STORAGE_FTP_DIR_PATH = (By.XPATH, f"{EMAIL_CONFIG_SCOPE}//input[@name='dirPath']")

    # Common buttons (global)
    STORAGE_RESET_BTN = (By.XPATH, f"{EMAIL_CONFIG_SCOPE}//button[@title='Reset']")
    STORAGE_SAVE_BTN  = (By.XPATH, f"{EMAIL_CONFIG_SCOPE}//button[@title='Save']")
    STORAGE_EDIT_BTN  = (By.XPATH, f"{EMAIL_CONFIG_SCOPE}//button[@title='Edit']")
    STORAGE_TEST_BTN  = (By.XPATH, f"{EMAIL_CONFIG_SCOPE}//button[@title='Test Connection']")

    ERROR_TEXT = "Connection failed. ERROR: sftp.connect: All configured authentication methods failed after 2 attempts"
    INVALID_INPUT_PATH = (By.XPATH, f"{EMAIL_CONFIG_SCOPE}//div[contains(@class, 'invalid-tooltip')]")
    INVALID_HOST_PATH=(By.XPATH, f"{EMAIL_CONFIG_SCOPE}//input[@name='host']/following-sibling::div[normalize-space()='This field is required']")
    INVALID_PORT_PATH = (By.XPATH,
                         f"{EMAIL_CONFIG_SCOPE}//input[@name='port']/following-sibling::div[normalize-space()='This field is required']")
    INVALID_PASSWORD_PATH = (By.XPATH,
                         f"{EMAIL_CONFIG_SCOPE}//input[@name='password']/following-sibling::div[normalize-space()='This field is required']")
    INVALID_USER_PATH = (By.XPATH,
                         f"{EMAIL_CONFIG_SCOPE}//input[@name='user']/following-sibling::div[normalize-space()='This field is required']")
