...
class EmailSAConfig(BasePage):
    EMAIL_CONFIG_SCOPE = "//div[@id='media-configuration-email']"


    TAB_SENTIMENT_ANALYSIS = (By.XPATH, f"{EMAIL_CONFIG_SCOPE}//button[@id='sa-tab-email']")

    TOGGLE_SA = (By.XPATH,
                 f"{EMAIL_CONFIG_SCOPE}//*[@id='sa-tab-email-pane']/div/form/div/div/div[2]/div/div[1]/div/label[2]/span")
    SA_TOGGLE_INPUT = (By.XPATH, "//input[@name='isEnableSA']")


    SA_SAVE_BTN = (By.XPATH, f"{EMAIL_CONFIG_SCOPE}//*[@id='sa-tab-email-pane']//button[@title='Save']")
    SA_RESET_BTN = (
        By.XPATH,
        "//div[@id='sa-tab-email-pane']//button[@title='Reset']"
    )
    SA_EDIT_BTN = (By.XPATH,
                   f"{EMAIL_CONFIG_SCOPE}//*[@id='sa-tab-email-pane']/div/form/div/div/div[2]/div/div[2]/div/div/button")
    SA_TEST_EDIT_BTN = (By.XPATH, f"{EMAIL_CONFIG_SCOPE}//*[@id='sa-tab-email-pane']//button[text()='Test']/following-sibling::button[@title='Edit']")
    SA_EDIT_KEY_FILE = (By.XPATH, f"{EMAIL_CONFIG_SCOPE}//*[@id='sa-tab-email-pane']//input[@name='prevKeyFile']/following-sibling::button[@title='Edit']")
    SA_SELECT_ENGINE = (By.XPATH, f"{EMAIL_CONFIG_SCOPE}//select[@name='engineNameSA']")
    SA_RADIO_CONVERSION_MODE = (By.XPATH, f"{EMAIL_CONFIG_SCOPE}//*[@id='manualModeSa_email']")
    SA_KEY_FILE_INPUT = (By.NAME, "keyFile")
    SA_TEST_BTN = (By.XPATH, f"{EMAIL_CONFIG_SCOPE}//button[text()='Test']")
    SA_TEXT_AREA = (By.XPATH, "//*[@id='sentiment_text']")
    SA_SUBMIT = (By.XPATH, "//button[text()='Submit']")
    SA_CANCEL = (By.XPATH, "//button[text()='Cancel']")
    SA_RADIO_CONVERSION_MODE_MANUAL = (By.XPATH, f"{EMAIL_CONFIG_SCOPE}//*[@id='manualModeSa_email']")
    SA_RADIO_CONVERSION_MODE_AUTO = (By.XPATH, f"{EMAIL_CONFIG_SCOPE}//*[@id='autoModeSa_email']")
    MODAL_TITLE = (By.XPATH, "//div[@class='modal-title h4']//span")
    SA_MODAL_SUBMIT = (By.XPATH, "//button[text()='Submit']")
    SA_TEST_AGAIN_BTN = (By.XPATH, f"{EMAIL_CONFIG_SCOPE}//button[text()='Test Again']")
    ...
    EDIT_LOC_MAIN = (By.XPATH, "//div[@id='sa-tab-email-pane']//button[@title='Edit']")
    EDIT_LOC_TEST = (By.XPATH,
                     "//div[@id='sa-tab-email-pane']//button[text()='Test']/following-sibling::button[@title='Edit']")
    EDIT_LOC_TEST_AGAIN = (By.XPATH,
                           "//div[@id='sa-tab-email-pane']//button[text()='Test Again']/following-sibling::button[@title='Edit']")

    SA_EDIT_TOGGLE_INPUT = (By.XPATH,
        f"{EMAIL_CONFIG_SCOPE}//input[@name='isEnableSA']"
    )

    EDIT_TOGGLE_SA = (By.XPATH,
        f"{EMAIL_CONFIG_SCOPE}//input[@name='isEnableSA']/following-sibling::span"
    )
    BTN_EDIT_MAIN = (By.XPATH,
                     "//div[@id='sa-tab-email-pane']//button[@class='section_form_acts_btn' and @title='Edit']")
