...
class EmailSAConfig(BasePage):
    CALL_CONFIG_SCOPE = "//div[@id='media-configuration-email']"


    TAB_SENTIMENT_ANALYSIS = (By.XPATH, f"{CALL_CONFIG_SCOPE}//button[@id='sa-tab-email']")

    TOGGLE_SA = (By.XPATH,
                 f"{CALL_CONFIG_SCOPE}//*[@id='sa-tab-email-pane']/div/form/div/div/div[2]/div/div[1]/div/label[2]/span")
    SA_SAVE_BTN = (By.XPATH, f"{CALL_CONFIG_SCOPE}//*[@id='sa-tab-email-pane']//button[@title='Save']")
    SA_RESET_BTN = (By.XPATH, f"{CALL_CONFIG_SCOPE}//button[@title='Reset']")
    SA_EDIT_BTN = (By.XPATH,
                   f"{CALL_CONFIG_SCOPE}//*[@id='sa-tab-email-pane']/div/form/div/div/div[2]/div/div[2]/div/div/button")
    SA_SELECT_ENGINE = (By.XPATH, f"{CALL_CONFIG_SCOPE}//select[@name='engineNameSA']")
    SA_RADIO_CONVERSION_MODE = (By.XPATH, f"{CALL_CONFIG_SCOPE}//*[@id='manualModeSa_email']")
    ...
    SA_RADIO_CONVERSION_MODE_MANUAL = (By.XPATH, f"{CALL_CONFIG_SCOPE}//*[@id='manualModeSa_email']")
    SA_RADIO_CONVERSION_MODE_AUTO = (By.XPATH, f"{CALL_CONFIG_SCOPE}//*[@id='autoModeSa_email']")
    ...
    def __init__(self, driver):
        ...
        email_config = full_config.get("channel_config", {}).get("email", {})
        sa_config = email_config.get("sa", {})
        ...
        try:
            ...
            try:
                toggle_sa = self.driver.find_element(By.XPATH,
                                                     "//*[@id='sa-tab-email-pane']/div/form/div/div/div[2]/div/div[1]/div/label[2]/span")
